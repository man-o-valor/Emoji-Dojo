...
const emojis = [
{emoji:"👏",id:0,hp:4,dmg:0,rarity:0,names:["Clap"],description:"Deals 1 more damage for each other undefeated friendly 👏"},
{emoji:"😘",id:1,hp:4,dmg:2,rarity:0,names:["Kissing Heart"],description:"When attacked, heals the friendly Emoji in front of it by 1"},
{emoji:"😌",id:2,hp:4,dmg:2,rarity:0,names:["Relieved"],description:"Takes 1 less damage from every attack, to a minimum of 1"},
{emoji:"😰",id:3,hp:6,dmg:1,rarity:0,names:["Cold Sweat"],description:"When attacked, switches places with the friendly Emoji behind it"},
...
{emoji:"🗣️",id:6,hp:4,dmg:2,rarity:2,names:["Speaking Head"],description:"When attacking at more than 2 health, lowers the enemy Emoji's attack power by 1 to a minumum of 0"},
{emoji:"😶",id:7,hp:1,dmg:1,rarity:-1,names:["No Mouth"],description:"Nothing special"},
...
{emoji:"🎓",id:9,hp:1,dmg:0,rarity:1,names:["Mortar Board"],description:"When attacked or defeated, summons three 👏 with 1 health and one attack value and defeats itself"},
{emoji:"🔀",id:10,hp:1,dmg:0,rarity:0,names:["Twisted Rightwards Arrows"],description:"When attacked or defeated, Shuffles the enemy Squad and defeats itself"},
{emoji:"🪦",id:11,hp:1,dmg:2,rarity:0,names:["Headstone"],description:"When a friendly Emoji is defeated, heals itself by 1"},
{emoji:"🥋",id:12,hp:2,dmg:2,rarity:0,names:["Martial Arts Uniform"],description:"The friendly Emoji in front of this attacks for 1 more damage"},
...
{emoji:"🎵",id:14,hp:1,dmg:1,rarity:0,names:["Musical Note"],description:"Nothing special"},
{emoji:"🎣",id:15,hp:3,dmg:1,rarity:0,names:["Fishing Pole And Fish"],description:"When attacked, moves the furthermost enemy emoji to the front of the enemy Squad"},
...
{emoji:"♟️",id:20,hp:1,dmg:2,rarity:0,names:["Chess Pawn"],description:"When this defeats an Emoji, summon a 👑 and defeat itself"},
{emoji:"👑",id:21,hp:8,dmg:3,rarity:-1,names:["Crown"],description:"Nothing special"},
{emoji:"😡",id:22,hp:3,dmg:0,rarity:0,names:["Rage"],description:"Attacks for the number of undefeated enemy Emojis to a maximum of 3"},
{emoji:"🦎",id:23,hp:3,dmg:1,rarity:0,names:["Lizard"],description:"If this is the only undefeated friendly Emoji, become a 🐲"},
{emoji:"🐲",id:24,hp:6,dmg:5,rarity:-1,names:["Dragon Face"],description:"Nothing special"},
{emoji:"☠️",id:25,hp:3,dmg:1,rarity:2,names:["Skull Crossbones"],description:"When an enemy Emoji is killed, heals the friendly Emoji behind it by 1"},
{emoji:"🍒",id:26,hp:2,dmg:1,rarity:1,names:["Cherries"],description:"At the beginning of the Battle, doubles itself"},
{emoji:"🌀",id:27,hp:4,dmg:1,rarity:1,names:["Cyclone"],description:"When your Squad is Shuffled, Shuffles the opponent Squad and defeats itself (Only one takes effect if multiple are undefeated)"},
{emoji:"🛻",id:28,hp:4,dmg:3,rarity:1,names:["Pickup Truck"],description:"When your Squad is Shuffled, moves to the back"},
{emoji:"🚏",id:29,hp:1,dmg:2,rarity:1,names:["Busstop"],description:"When your Squad is Shuffled, heals the Emoji behind itself by 2"},
...
{emoji:"🌳",id:32,hp:3,dmg:2,rarity:2,names:["Deciduous Tree"],description:"While undefeated, your squad cannot be Shuffled"},
{emoji:"💨",id:33,hp:1,dmg:1,rarity:0,names:["Dash"],description:"Before your Squad is Shuffled, heals the frontmost friendly Emoji by 2"},
{emoji:"⚡",id:34,hp:2,dmg:2,rarity:2,names:["Zap"],description:"Attacks the 2 frontmost enemy emojis at once"},
{emoji:"🧱",id:35,hp:2,dmg:1,rarity:0,names:["Bricks"],description:"Takes 2 less damage from every attack, to a minimum of 1. Cannot be healed"},
...
{emoji:"✨",id:38,hp:3,dmg:-1,rarity:-1,names:["Sparkles"],description:"Nothing special"},
{emoji:"🦄",id:39,hp:3,dmg:2,rarity:2,names:["Unicorn"],description:"When defeated, summons ✨ at the front of the enemy Squad"},
{emoji:"🃏",id:40,hp:8,dmg:2,rarity:0,names:["Black Joker"],description:"Increases any damage taken to itself by 1"},
{emoji:"🌪️",id:41,hp:3,dmg:1,rarity:1,names:["Cloud Tornado"],description:"When attacked or defeated, Shuffles the enemy Squad"},
{emoji:"💃",id:42,hp:3,dmg:1,rarity:1,names:["Dancer"],description:"After attacking, switches places with the friendly Emoji behind it"},
{emoji:"🪅",id:43,hp:4,dmg:1,rarity:1,names:["Piñata"],description:"When defeated, heals the new frontmost friendly Emoji by 2 and damages the frontmost enemy Emoji by 2"},
{emoji:"🎻",id:44,hp:3,dmg:2,rarity:0,names:["Violin"],description:"If there is at least one undefeated friendly 🎵, deal 3 more damage"},
