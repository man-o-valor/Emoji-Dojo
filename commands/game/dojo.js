...
const {raritycolors,database,getvault,emojis,raritysymbols,raritynames,trysetupuser,getsquad,devoteemojis,classes,fetchresearch,devotionhelp} = require('../../data.js')
